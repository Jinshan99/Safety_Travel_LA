...
def predict():
    ...
    def dangerous_level_check():
        ...
        for i in range(len(g_LAT_LON)):
            lat_start, lat_end, lon_start, lon_end, step = 33.706, 34.335, - \
                118.668, -118.155, 0.0015
    ...
    # process section
    # C:/Users/wn199/Desktop/DSCI560project/DSCI560project/src/backend/, C:/Users/wn199/Desktop/DSCI560project/DSCI560project/src/backend/, C:/Users/wn199/Desktop/DSCI560project/DSCI560project/src/backend/
    police, hospital, regions = load_json_file(
        "policecoordinates.json", "hospitalcoordinates.json", "location.json")
    ...
    def make_input_for_model():
        output = []
        for i in range(len(g_LAT_LON)):
            each_data = [g_LAT_LON[i][0], g_LAT_LON[i][1], day,
                         month, year, p_list[i], h_list[i], danger_list[i], time]
        ...
        if index_Lon > 342 or index_Lat > 420:
            ...
            if index_Lat >= 1 and index_Lon >= 1:
                safe_list_score = [regions[index_Lat - 1][index_Lon - 1], regions[index_Lat - 1][index_Lon], regions[index_Lat - 1][index_Lon + 1],
                                   regions[index_Lat][index_Lon -
                                                      1], regions[index_Lat][index_Lon], regions[index_Lat][index_Lon + 1],
                ...
                if min_index < 3:
                    if min_index == 0:
                        answer = [g_LAT_LON[i][0] - 0.0015,
                                  g_LAT_LON[i][1] - 0.0015]
                    elif min_index == 1:
    ...
    # model = joblib.load(urlopen("https://drive.google.com/file/d/1t0_O2ZbPere35JMarb9RlbomQ_DbkNez/view?usp=share_link"))
    # # Download the model file
    # url = "https://drive.google.com/uc?id=1t0_O2ZbPere35JMarb9RlbomQ_DbkNez"
    ...
    # C:/Users/wn199/Desktop/DSCI560project/DSCI560project/src/backend/
